...
Initially, the activate method in the kernel directly applied the sigmoid activation function. However, to allow for flexibility and potential use of different activation functions, I've decided to separate the activation function into its own secondary method, applyActivationFunction. This way, users can choose or even implement their own activation functions as needed.
